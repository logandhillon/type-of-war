...
public class TypeOfWarPracticeScene extends TypeOfWarScene {
    ...
    public TypeOfWarPracticeScene(TypeOfWar game, int computerWPM) {
        super(
                game, List.of(new PlayerObject("Player1", Color.CYAN)),
                List.of(new PlayerObject("Computer", Color.GREY))); //TODO: Connect this to main menu values
    ...
    public void endGame(boolean won) {
        ...
        playerResults[0] = stats.toEndResultEntity(
        ...
        computerResults[0] = new EndResultEntity(
                this.computerWPM, -1, Math.round(wordsCounter), (new PlayerObject("COMPUTER", Color.GREY)));
